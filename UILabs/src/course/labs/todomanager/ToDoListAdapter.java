...
public class ToDoListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		titleView.setId(R.id.titleView);
		...
		//View findViewById = priorityView.findViewById(R.id.priorityGroup);
		//View priprityGroup = priorityView.findViewById(R.id.priorityGroup);
